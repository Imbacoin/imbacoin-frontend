...
import vorotaopen from "../images/vorotaopen.png"
...
import path_all from "../images/path_all.png";
...
function IntroDesktop() {
    ...
    useEffect(() => {
      ...
      /*  gsap.to(".left_light1", {
       ...
       // const anim_path =  gsap.timeline({ paused:true}).fromTo("#circleMask", 2, {scaleY:0}, {scaleY:1}, '<+=3' );
        ...
        tl_intro.current = gsap.timeline()
            ...
            .fromTo(q("#circleMask"), {scaleX:0}, {/*repeat:-1, repeatDelay:2,*/duration: 0.5,scaleX:1}, '<+=0' )
            .fromTo(q(".path_left_lite"),
                { scale:0, xPercent: -30, yPercent: 200},
                {scale: 1, xPercent: 0, yPercent: 0, duration: 0.5, ease: "power3.Out"}, "<+=0")
            .to(".path_right_top", {opacity: 1, y: 0, x: 0, duration: 0.5, ease: "power3.Out"}, "<+=0.2")
            .to(".path_left_top", {opacity: 1, y: 0, x: 0, duration: 0.5, ease: "power3.Out"}, "<+=0.3")
            .fromTo(q(".path_right_bottom"),
                { scale:0, xPercent: 50, yPercent: 200},
                { scale:1, xPercent: 0, yPercent: 0,duration: 0.5, ease: "power3.Out"}, "<+=0.4")
            .fromTo(q(".ball"),
                {opacity: 0},
            ...
            .fromTo(q(".vorota"),
                {opacity:1},
                {opacity:0, duration: 0.2, ease:"back"}, "<+=0.1")
    ...
    const startForm = () => {
        ...
        tl_start.current = gsap.timeline({
            ...
            .to(".vorotaopen", {top: '-20vh', duration: 2, ease: "power4.inOut"}, "<")
    ...
    return (
        <div className="intro_wrap" ref={containerRef}>
            <div className="scene">
                ...
                <svg id="desktop_path"  className="suspense" data-name="Layer 1" width="100%" viewBox="0 0 168 331">
                    <defs>
