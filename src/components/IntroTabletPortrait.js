...
import vorota_after from "../images/tablet_P/vorota_after.png"
        ...
        if (!isLoading) {
            ...
            let ctx = gsap.context(() => {
                tl_intro.current = gsap.timeline()
                    .to(q(".scene"), {opacity: 1, scale: 2, xPercent: -50, yPercent: 20, duration: 1, ease: "back"})
                    ...
                    .fromTo(q(".vorota_after"), {opacity: 0}, {opacity: 1, duration: 1}, "<+=0.2")
                    .fromTo(q(".ball_oreol"),
                        {opacity: 0},
